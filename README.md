...
- **[FlashCards](https://github.com/PantoYT/FlashCards)** - Offline flashcard app with smart weighted randomization

## Tech Stack

**Languages:** Python • C++ • JavaScript • PHP  
**Web:** HTML • CSS  
**Tools:** Tkinter • Discord.py • MariaDB  
**Design:** Photoshop • Premiere Pro • Aseprite • Fusion 360

## Fun Stuff

I also create automation systems and vehicles in Scrap Mechanic - check out my [Steam Workshop](https://steamcommunity.com/id/pantoyt/myworkshopfiles/)!

## Get in Touch

- **Email:** halasawojciech@gmail.com
- **YouTube:** [@pantoyt](https://www.youtube.com/@pantoyt)

---

Currently learning and building new things every day
